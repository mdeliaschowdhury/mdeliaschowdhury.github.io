...
var i=a("<span/>").addClass("flagstrap-selected-"+s).html(t).append(e),r=a("<button/>").attr("type","button").attr("data-bs-toggle","dropdown").attr("id","flagstrap-drop-down-"+s).addClass("btn-myflag btn d-flex align-items-center justify-content-between "+o.settings.buttonType+" "+o.settings.buttonSize+" dropdown-toggle").html(i)
return a("<span/>").addClass("my-caret").css("margin-left",o.settings.labelMargin).insertAfter(i).css("transition",o.settings.myTransition).insertAfter(i),r},S=function(){var e=a("<ul/>").attr("id","flagstrap-drop-down-"+s+"-list").attr("aria-labelled-by","flagstrap-drop-down-"+s).addClass("myflag--dropdown-menu dropdown-menu")
...
var r=a("<a/>").attr("data-val",a(this).val()).html(i).append(n).on("click",function(e){a(c).val(a(this).data("val")),a(c).trigger("change"),a(".flagstrap-selected-"+s).html(a(this).html()),e.preventDefault()}),l=a("<li/>").prepend(r).addClass('flag-link');
e.append(l)}),e}
